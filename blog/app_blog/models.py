...
class Article1(models.Model):
    title = models.CharField(u'Інформація', max_length=250,
                             help_text=u'Максимум 250 сим.')
    description = models.TextField(blank=True,
                                   verbose_name=u'Опис')
    pub_date = models.DateTimeField(u'Дата публікації',
    ...
    category = models.ForeignKey(Category,   
                                related_name='articles1', blank=True, null=True,  
                                verbose_name=u'Категорія',on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        verbose_name_plural = u'Додаткова інформація'
...
class ArticleImage1(models.Model):
    article = models.ForeignKey(Article1, 
                                verbose_name=u'Додаткова інформація',
                                related_name='images',
                                on_delete=models.CASCADE)
    image = models.ImageField(u'Фото', upload_to='photos')
    ...
    class Meta:
        verbose_name = u'Фото для інформації'
        verbose_name_plural = u'Фото для інформації'
